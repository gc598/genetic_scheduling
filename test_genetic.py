...
job0 = sc.Job([copy.deepcopy(t1),copy.deepcopy(t2),copy.deepcopy(t3)],80)

#sample test 2
s3 = sc.Task(30,5,1,2,[2,3,7])
s2 = sc.Task(30,15,1,2,[2,3,7,5])
s1 = sc.Task(30,5,1,2,[2,3,7])
job1 = sc.Job([copy.deepcopy(s1),copy.deepcopy(s2),copy.deepcopy(s3)],120)

#sample test 3
u3 = sc.Task(15,5,2,3,[2,3,7])
u2 = sc.Task(30,30,2,3,[2,3,7,5])
u1 = sc.Task(30,10,2,3,[2,3,7]) 
job2 = sc.Job([copy.deepcopy(u1),copy.deepcopy(u2),copy.deepcopy(u3)],160)
